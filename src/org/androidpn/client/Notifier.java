...
public class Notifier {
    ...
    public void notifyMsg(String msgId, String type, String fromUser, String toUser,
    		String body, String sentDate, String packetId) {
        Log.d(LOGTAG, "notifyMsg()...");

        Log.d(LOGTAG, "msgId=" + msgId);
        Log.d(LOGTAG, "type=" + type);
        Log.d(LOGTAG, "fromUser=" + fromUser);
        Log.d(LOGTAG, "toUser=" + toUser);
        Log.d(LOGTAG, "body=" + body);
        Log.d(LOGTAG, "sentDate=" + sentDate);
        ...
        if (isNotificationEnabled()) {
        	...
        	if(fromUser.compareTo(toUser) < 0)
        		paticipants = fromUser + "_" + toUser;
        	else
        		paticipants = toUser + "_" + fromUser;
        	Chat chat = DBManager.getInstance(context).getChat(Constants.CHAT_EXTRA, paticipants);
