...
public class NotificationService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        Log.d(LOGTAG, "username="+intent.getStringExtra("username"));
        Log.d(LOGTAG, "password="+intent.getStringExtra("password"));
        xmppManager.setUsername(intent.getStringExtra("username"));
        xmppManager.setPassword(intent.getStringExtra("password"));
    }
    ...
    private void registerUserReceiver() {
        IntentFilter filter = new IntentFilter();
        filter.addAction(Constants.ACTION_SHOW_USER);
    ...
    private void registerMessageReceiver() {
        IntentFilter filter = new IntentFilter();
        filter.addAction(Constants.ACTION_SHOW_MESSAGE);
